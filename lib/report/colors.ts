...
export const CALENDAR_RECORD_TYPE_CHART_COLORS: Record<CalendarRecordType, string> = {
  ...
  [CalendarRecordType.SickDay]: "var(--c-sickday)",
  [CalendarRecordType.BankHoliday]: "var(--c-bank)",
  [CalendarRecordType.NonPaidLeave]: "var(--c-nonpaid)",
  [CalendarRecordType.PaidTimeOff]: "var(--c-pto)",
  [CalendarRecordType.StudyLeave]: "var(--c-study)",
  [CalendarRecordType.Other]: "var(--c-other)",
};
