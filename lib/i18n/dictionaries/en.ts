...
export const en = {
  ...
  clock: {
    title: "My attendance",
    subtitle: "Your clock and today's sessions.",
    open: "Clock",
    ...
    noOpenSession: "You are not clocked in.",
    noOpenBreak: "You are not on a break.",
    breakAlreadyOpen: "A break is already running.",
    employmentEnded: "Your employment here has ended, so the clock is closed.",
    planLapsed: "Attendance is not active for your organization.",
    failed: "Could not update your clock",
    today: "Today",
    presence: "Presence",
    breaks: "Breaks",
    sessions: "Sessions",
    ...
    excludedClockInFlag: "Excluded day",
    upcoming: "To come",
    hatchedLegend:
      "Hatched days are days off: a non-working day, a public holiday or an approved absence. Dashed days are still to come.",
    dayOff: "Day off",
    excludedDays: "Excluded days",
    ofDays: (count: number) => `of ${count}`,
    notEmployed: "Not employed",
    nonWorkingDay: "Non-working day",
    publicHoliday: "Public holiday",
    absent: "Absent",
    halfDayOf: (value: string) => `of ${value}, half day`,
  ...
  teamAttendance: {
    ...
    everyone: (organization: string, count: number) =>
      `Everyone in ${organization}, ${count} ${count === 1 ? "person" : "people"}.`,
    group: (group: string, count: number) =>
      `${group}, ${count} ${count === 1 ? "person" : "people"}.`,
    yourGroups: (count: number) => `Your groups, ${count} ${count === 1 ? "person" : "people"}.`,
    views: { week: "Week", month: "Month", range: "Range" },
    from: "From",
    to: "To",
    rangeTooLong: (days: number) => `At most ${days} days at a time.`,
    rangeInsideOut: "The range ends before it starts.",
    allGroups: "All groups",
    groupFilter: "Group",
    organizationFilter: "Organization",
    inNow: "In now",
    nobodyIn: "Nobody is clocked in.",
    onBreak: "on break",
    sinceDay: (day: string, time: string) => `since ${day} ${time}`,
    person: "Person",
    period: "Period",
    noGroup: "No group",
    notInYet: "Not in yet",
    nothingRecorded: "Nothing recorded in this range.",
    nobody: "Nobody to show.",
    notAllowed: "Team attendance is for group admins and organization admins.",
    loadFailed: "Could not load the team's attendance.",
    legendAutoClosed: "Auto-closed after the ceiling, set the real time",
  ...
  corrections: {
    title: (day: string) => `Correct ${day}`,
    editToday: "Edit today's times",
    correctDay: (person: string, day: string) => `Correct ${person}'s ${day}`,
    clockIn: "Clock in",
    clockOut: "Clock out",
    stillOpenHint: "Leave empty while the session is still running",
    was: (time: string) => `Was ${time}`,
    wasSwept: (time: string) => `Was ${time}, set by the sweep`,
    breaks: "Breaks",
    noBreaks: "No breaks recorded.",
    removeBreak: "Remove break",
    to: "to",
    deleteSession: "Delete session",
    deleteSessionConfirm: "Delete this session? Its history stays, the time stops counting.",
    save: "Save correction",
    saving: "Saving…",
    close: "Close",
    history: "History",
    historyEmpty: "Nothing recorded yet.",
    noSessions: "Nothing was recorded on this day.",
    ...
    events: {
      ...
      LOCATION_UPDATED: "Location recorded",
      SESSION_EDITED: "Times corrected",
  ...
  newRequest: {
    ...
    uploadingFiles: "Uploading files. The window closes once they have been checked.",
    uploadProblems:
      "Some files were not accepted. Replace them here, or later from the request's details.",
    uploadsAccepted: "Every file was accepted.",
  },
  ...
  attachments: {
    ...
    failed: "Upload failed. The file did not arrive.",
    rejected: {
      TYPE_MISMATCH: "Rejected: the file's contents don't match its type.",
      IMAGE_UNREADABLE: "Rejected: the image couldn't be read.",
      PDF_JAVASCRIPT: "Rejected: the PDF contains scripts.",
      PDF_LAUNCH_ACTION: "Rejected: the PDF contains launch actions.",
      PDF_ENCRYPTED: "Rejected: the PDF is password-protected.",
    },
    preview: (name: string) => `Preview ${name}`,
    open: (name: string) => `Open ${name}`,
    download: (name: string) => `Download ${name}`,
    openFailed: "Couldn't open the file. Try again.",
    addFiles: "Add files",
    addFilesHint: "Click or drop them here. Images or PDF, up to 10 MB each.",
    slotsUsed: (used: number, max: number) => `${used} of ${max} files attached`,
    visibilityNotice: "Approvers and managers of the group can see attached files.",
    paidPlanOnly: "Attachments need a paid plan. Files already attached stay available.",
    limitReached: "This request has all five of its files.",
    limitReachedHint: "Remove one to attach another.",
  ...
  groups: {
    ...
    inviteInput: "Invite link or code",
    inviteInputPlaceholder: "Paste the link or code from your invite",
    inviteInputHint: "Use the link from your invite email, or a code from your group admin.",
    join: "Join group",
    joining: "Joining…",
  ...
  dashboard: {
    ...
    noGroupsBody:
      "Join your team with the link or code from your invite, or create a group of your own.",
    stats: {
  ...
  join: {
    ...
    invitedBy: (name: string) => `${name} invited you to this group on flexiday.`,
    ...
    usedTitle: "This invite has been used",
    used: "Each invite works once. If you still need to join, ask your group admin for a new one.",
    expiredTitle: "This invite has expired",
    expired: "Ask your group admin to send you a new invite.",
    revokedTitle: "This invite is no longer valid",
    revoked: "It was withdrawn or replaced by a newer one. Ask your group admin for a new invite.",
    notFoundTitle: "Invite not found",
    notFound: "This invite link is incomplete or wrong. Open it again from your invite email.",
    alreadyMemberTitle: "You're already in this group",
    alreadyMember: (group: string) => `You're already a member of ${group}.`,
    openGroup: "Open the group",
    toDashboard: "Go to dashboard",
    loadFailed: "Couldn't load this invite. Please try again.",
    failed: "Couldn't join the group. Please try again.",
  },
  ...
  organization: {
    ...
    people: {
      title: "People",
      lead: "Everyone employed here. Give anyone whose contract differs their own required daily time; the rest follow the organization's.",
      requiredLabel: "Required per day",
      usingOrganization: (value: string) => `Organization's ${value}`,
      save: "Save",
      clear: "Clear",
      saved: "Required time updated",
      invalid: "Use h:mm, for example 6:00.",
      saveFailed: "Could not save the required time",
      ended: "Ended",
      empty: "Nobody is employed here yet.",
      loadFailed: "Could not load the people in this organization.",
    },
    attendance: {
      title: "Attendance",
      lead: "Clock in and out, breaks, worked time and a team dashboard.",
      leadOn: (name: string) =>
        `On for everyone in ${name}. People clock in from the app; admins see the team.`,
      switchLabel: "Turn attendance on",
      paidOnlyTitle: "Available on Pro and Enterprise",
      paidOnlyBody:
        "Attendance turns on for the whole organization once the plan allows it. Nothing is recorded until you switch it on.",
      seePlans: "See plans",
      dormant:
        "The subscription has lapsed, so attendance is dormant — clocking in is refused, nothing is deleted, and re-subscribing restores it.",
      timezoneLabel: "Timezone",
      timezoneHint:
        "Required to turn attendance on. Proposed from your browser. Sets the day boundary; a night shift belongs to the day it started.",
      timezoneRequired: "Choose a timezone before turning attendance on.",
      timezonePlaceholder: "Choose a timezone",
      holidayCountryLabel: "Holiday country",
      holidayCountryHint: "Public holidays here are excluded days.",
      holidayCountryNone: "No public holidays",
      workingDaysLabel: "Working days",
      workingDaysHint: "Other days are excluded; clocking in on them still counts.",
      workingDaysRequired: "Choose at least one working day.",
      breaksHeading: "Breaks",
      breakAllowanceLabel: "Break allowance",
      breakAllowanceHint:
        "Deducted from every day that passes the threshold, whether or not a break was taken. A longer break is deducted in full.",
      minutesUnit: "min",
      breakThresholdLabel: "Threshold",
      breakThresholdHint: "Presence below this deducts only breaks actually taken.",
      requiredHeading: "Required time",
      requiredPerDayLabel: "Required per day",
      requiredPerDayHint: "A person can be given their own required time.",
      balanceLabel: "Balance",
      balanceDaily: "Each day",
      balanceMonthly: "Over the month",
      balanceHint:
        "Each day colours every day against its required time. Over the month reports one balance and colours nothing else. Neither enforces anything.",
      ceilingsHeading: "Ceilings",
      sessionCeilingLabel: "Close a session after",
      sessionCeilingHint: "A forgotten clock-out is closed here and flagged for correction.",
      breakCeilingLabel: "Close a break after",
      breakCeilingHint: "A forgotten break ends here and is flagged the same way.",
      durationHint: "h:mm",
      durationInvalid: "Use h:mm, for example 8:00.",
      locationLabel: "Record location at clock-in and clock-out",
      locationHint:
        "The browser asks each person for permission every time. Declining is never recorded, never flagged. Coordinates are kept for twelve months.",
      locationResponsibilityTitle: "Agreeing this with your employees is your responsibility",
