...
export const en = {
  ...
  groupDetail: {
    ...
    mirroring: {
      title: "Mirror my records into this group",
      description: (groupName: string) =>
        `Show your time off from other groups inside ${groupName}, without needing approval here.`,
      save: "Save mirroring",
      updated: "Mirroring updated.",
      failed: "Could not save mirroring",
      noOtherGroups: "You are not in any other group to mirror from.",
      note: "Mirrored records are read-only here. They are still approved, counted against your allowance and reported in the group they were booked in.",
    },
  },
