...
export const en = {
  ...
  attachments: {
    ...
    addFiles: "Add files",
    addFilesHint: "PNG, JPEG, WebP, HEIC or PDF, up to 10 MB each, five per request.",
    visibilityNotice: "The group's approvers and managers will see this file.",
    paidPlanOnly: "Attachments need a paid plan. Files already attached stay available.",
    limitReached: "This request has the maximum of five attachments.",
