...
export const cs: Dictionary = {
  ...
  clock: {
    title: "Moje docházka",
    subtitle: "Tvoje píchačky a dnešní směny.",
    open: "Píchačky",
    notClockedIn: "Nepíchnuto",
    clockedIn: "Píchnuto",
    onBreak: "Na pauze",
    since: (time: string) => `od ${time}`,
    nothingYet: "Zatím nic zaznamenáno",
    clockIn: "Píchnout příchod",
    clockOut: "Píchnout odchod",
    takeBreak: "Jít na pauzu",
    endBreak: "Ukončit pauzu",
    working: "Pracuje se…",
    inactiveTitle: "Píchání je vypnuté",
    inactiveBody:
      "Docházka je pro tvoji organizaci pozastavená, takže není co píchnout. Historie zůstává čitelná. Zeptej se správce organizace.",
    viewMyAttendance: "Zobrazit moji docházku",
    alreadyOpen: (time: string) => `Píchnuto od ${time}`,
    alreadyOpenBody: "Příchod už byl zaznamenán jinde. Až skončíš, píchni odchod.",
    noOpenSession: "Nemáš píchnutý příchod.",
    noOpenBreak: "Nejsi na pauze.",
    breakAlreadyOpen: "Pauza už běží.",
    employmentEnded: "Tvoje působení tady skončilo, píchačky jsou uzavřené.",
    planLapsed: "Docházka není pro tvoji organizaci aktivní.",
    failed: "Píchačky se nepodařilo aktualizovat",
    today: "Dnes",
    presence: "Přítomnost",
    breaks: "Pauzy",
    sessions: "Směny",
  ...
  teamAttendance: {
    ...
    inNow: "Teď v práci",
    nobodyIn: "Nikdo nemá píchnutý příchod.",
    onBreak: "na pauze",
